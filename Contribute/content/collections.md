...
The Collections feature supports all content types. Once you've created a collection, you can add any content from the Microsoft Learn site to the Collection by selecting the **Save** button available on all pages. You can add as many content items from the site as you like. Once added, you can rearrange and delete content as needed.
...
To rearrange content within the Collection, select the **up/down** arrows on the content items. A pop-up appears alerting you that the content will be permanently deleted. Select **Yes, delete** to delete the content.

### Delete content

To delete content within a Collection, select the **trash can** icon on the content item.

## Add and manage sections

Once you've saved content to your Collection, you can add sections to the Collection to make it easier to navigate. You can add as many sections as you need. You can also move items between sections, and move sections up and down in the Collection. And if you change your mind, you can delete sections and items from the Collection.
...
To rearrange section, select the **up/down** arrows on the section header.
