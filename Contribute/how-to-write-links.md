...
A URL link can be a URL path that is relative to the root of `https://docs.microsoft.com`, or an absolute URL that includes the full URL syntax (for example, `https://github.com/MicrosoftDocs/PowerShell-Docs`).
