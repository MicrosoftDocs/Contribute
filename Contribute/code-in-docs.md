...
* *Class scaffolding* `try-dotnet-class`: The code block should represent a class with a `Main` method as the program entry point. These can be used to show how members of a clas interact.
