...
Several of the Microsoft documentation sets are open source and hosted on GitHub. Some document sets are not completely open source but many have public-facing repos where you're able to make suggested changes via pull requests. This streamlines and improves communication between the product engineers, the content teams and our customers. Working open source like this provides several advantages:
